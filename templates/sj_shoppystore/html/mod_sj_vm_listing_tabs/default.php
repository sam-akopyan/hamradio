...
if (!empty($list)) {
    ...
    ?>
    <!--[if lt IE 9]>
    <div id="<?php echo $tag_id; ?>" class="sj-listing-tabs msie lt-ie9 first-load <?php echo $class_suffix;?>"><![endif]-->
    <!--[if IE 9]>
    <div id="<?php echo $tag_id; ?>" class="sj-listing-tabs msie first-load <?php echo $class_suffix;?>"><![endif]-->
    <!--[if gt IE 9]><!-->
