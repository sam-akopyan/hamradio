...
function pagination_item_active(&$item) {
    ...
    {
        $display = '<i class="fa fa-caret-right l-hiden"></i> <i class="fa fa-caret-left r-hiden"></i>';
    }
    // Check for "Prev" item
    if ($item->text == JText::_('JPREV'))
    {
        $display = '<i class="fa fa-caret-right r-hiden"> </i> <i class="fa fa-caret-left l-hiden"></i>';
    }
