...
if (!empty($list)) {
    ...
    $btn_prev = ($params->get('button_page') == 'top') ? '<i class=\"fa fa-angle-left\"></i>':'&#139;';
    $btn_next = ($params->get('button_page') == 'top') ? '<i class=\"fa fa-angle-right\"></i>':'&#155;';
...
if(strpos($params->get('moduleclass_sfx'), 'fa-')===false){
   $modclass_sfx = $params->get('moduleclass_sfx');
    ...
    $iconx = "<span class='ex_icon'><i class='fa fa-".$fontName."'></i></span>";
    ...
    <div class="moduletable">
        ...
        <div id="<?php echo $tag_id ; ?>"
            ...
            <?php if($title_slider_display) { ?>
                <div class="heading-title"><?php echo $iconx; ?><?php echo $title_slider; ?></div>
            <?php } ?>
