...
jQuery(document).ready(function ($) {
    ...
    $("#<?php echo $module_id;?> .owl-carousel .item").each(function(){
        ...
        $(this).find('.item-deals').html('<div class="sj_deals_cd_day">'+(html_day)+'<span>:</span></div><div class="sj_deals_cd_day bg">'+html_hours+'</div><div class="sj_deals_cd_day"><span>:</span>'+html_minus+'</div>');
        i++;
        }
    });
        ...
        $("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.item-deals').html('<div class="sj_deals_cd_day">'+(html_day)+'<span>:</span></div><div class="sj_deals_cd_day bg">'+html_hours+'</div><div class="sj_deals_cd_day"><span>:</span>'+html_minus+'</div>');
        }
    setInterval(function(){
        ...
        $("#<?php echo $module_id;?> .owl-carousel .item").each(function(){
            ...
            $(this).find('.item-deals').find('.sj_deals_cd_day').eq(1).html('<span class="l">:</span>' + html_hours + '<span class="r">:</span>');
            ...
            var html_minus = parseInt((parseInt(mk_time_first_product) - parseInt(time_now) - html_day*days - html_hours*hours)/minutes);
            var html_seconds =  parseInt((parseInt(mk_time_first_product) - parseInt(time_now) - html_day*days - html_hours*hours - html_minus*minutes)/1000);
            $("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(0).html(html_day + '');
            $("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(1).html(html_hours + '');
            $("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(2).html(html_minus + '');
            $("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.sj_deals_cd_day').eq(3).html(html_seconds + '');
    }, 1000);
      <?php }?>
      setTimeout(function(){
