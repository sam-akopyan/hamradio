...
?>
<a class="modtitle" role="button" data-toggle="collapse" href="#<?php echo $menu_id; ?>" aria-expanded="true" aria-controls="<?php echo $menu_id; ?>"><?php echo $icons; ?><?php echo $module->title; ?></a>

<!--[if lt IE 9]><div id="<?php echo $menu_id; ?>" class="collapse in sambar msie lt-ie9 " data-sam="<?php echo $instance; ?>"><![endif]-->
<!--[if IE 9]><div id="<?php echo $menu_id; ?>" class="collapse in sambar msie  " data-sam="<?php echo $instance; ?>"><![endif]-->
<!--[if gt IE 9]><!--><div id="<?php echo $menu_id; ?>" class="collapse in sambar" data-sam="<?php echo $instance; ?>"><!--<![endif]-->
...
<ul class="sj-megamenu sj-megamenu<?php echo $wrap_cls;?> <?php if( $params->get('menu_event') == 'hover' ){
